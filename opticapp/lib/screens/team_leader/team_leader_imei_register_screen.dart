...
class TeamLeaderImeiRegisterScreen extends StatefulWidget {
  const TeamLeaderImeiRegisterScreen({super.key});

  @override
  State<TeamLeaderImeiRegisterScreen> createState() => _TeamLeaderImeiRegisterScreenState();
}

class _TeamLeaderImeiRegisterScreenState extends State<TeamLeaderImeiRegisterScreen> {
  ...
  Future<void> _load({int page = 1}) async {
    ...
    try {
      final data = await getTeamLeaderTeamInventory(
        agentId: _agentId,
                ...
                slivers: [
                  SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Every device assigned to agents on your team.',
                  ...
                  if (_loading)
                    ...
                    SliverFillRemaining(
                      ...
                      child: Center(
                        child: Text(
                          'No IMEI assignments for your team yet.',
