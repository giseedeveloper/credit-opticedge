{{-- iPhone-style hero devices — Field operations + Customer portal mockups --}}
<div class="relative mx-auto flex h-[520px] w-full max-w-xl items-center justify-center sm:h-[560px] lg:h-[600px] lg:max-w-none">
    <div class="animate-landing-drift absolute h-64 w-64 rounded-full bg-linear-to-br from-brand-blue/12 via-white to-brand-accent-soft shadow-[0_40px_80px_-24px_rgba(16,52,84,0.22)] ring-1 ring-brand-navy/5 lg:h-80 lg:w-80"></div>
            ...
            <div class="iphone-bezel">
                <div class="iphone-screen flex flex-col">
                    ...
                    <div class="landing-hero-gradient mx-2.5 rounded-2xl px-3.5 pb-3.5 pt-2 shadow-lg shadow-brand-navy/20">
                        ...
                        <p class="mt-0.5 text-[8px] font-medium text-white/75">3 actions require attention</p>
                    ...
                    <div class="mx-2.5 -mt-1.5 flex-1 space-y-1.5 px-0.5">
                        <div class="rounded-2xl border border-zinc-200/80 bg-white/95 p-2.5 shadow-sm backdrop-blur-sm">
                            <div class="flex items-start gap-2">
                                <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-linear-to-br from-brand-accent-soft to-white text-brand-accent shadow-sm ring-1 ring-brand-accent/15">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <p class="text-[7px] font-medium text-zinc-500">Asha M. · 62% · ID image blur</p>
                                </div>
                    ...
                    <div class="iphone-tab-bar mx-2.5 mb-1 mt-1 rounded-2xl">
                        @foreach ([
                            ...
                            ['Loan', false, 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                            ['More', false, 'M4 6h16M4 12h16M4 18h16'],
                        ] as $tab)
            ...
            <div class="iphone-bezel">
                <div class="iphone-screen iphone-screen--dark flex flex-col">
                    ...
                    <div class="landing-hero-gradient mx-2.5 rounded-2xl p-3 shadow-lg shadow-brand-navy/30">
                        <p class="text-[8px] font-bold uppercase tracking-wider text-white/65">My device loan</p>
                        <p class="mt-0.5 text-[1.35rem] font-extrabold leading-none tracking-tight text-white">TZS 408K</p>
                        <p class="mt-0.5 text-[8px] font-medium text-white/70">balance · Samsung A15</p>
                        <div class="mt-2.5 h-2 overflow-hidden rounded-full bg-white/15 ring-1 ring-white/10">
                            <span class="block h-full w-[68%] rounded-full bg-linear-to-r from-brand-accent to-orange-300 shadow-sm"></span>
                        </div>
                        <p class="mt-1 text-[7px] font-semibold text-white/60">68% repaid · 4 of 6 payments</p>
                    </div>

                    {{-- Face scan viewport (iOS camera style) --}}
                    <div class="relative mx-2.5 mt-2.5 flex-1 overflow-hidden rounded-2xl bg-linear-to-b from-zinc-900 to-black ring-1 ring-white/10">
                        ...
                        <div class="relative flex h-full flex-col items-center justify-center px-3 py-4">
                            <div class="animate-scan-pulse relative">
                                <div class="h-18 w-15 rounded-[48%] bg-linear-to-b from-zinc-600/80 to-zinc-800/90 shadow-inner ring-2 ring-emerald-400/70"></div>
                            ...
                            <p class="mt-3 text-[9px] font-extrabold text-emerald-400">Face detected</p>
                            <p class="text-[7px] font-medium text-white/50">ID scan · 75% pass threshold</p>
                            <div class="mt-2.5 flex items-center gap-1 rounded-full bg-white/8 px-2.5 py-1 ring-1 ring-white/10">
                                <span class="h-1.5 w-1.5 animate-pulse rounded-full bg-emerald-400"></span>
                                <p class="text-[6px] font-bold text-white/70">Live preview · server result pending</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mx-2.5 mt-2 grid grid-cols-2 gap-1.5">
                        <div class="rounded-xl bg-white/8 p-2 text-center ring-1 ring-white/10 backdrop-blur-sm">
                            <p class="text-[7px] font-semibold text-white/45">Due</p>
                            <p class="text-sm font-extrabold text-white">85K</p>
                        </div>
                        <div class="rounded-xl bg-white/8 p-2 text-center ring-1 ring-white/10 backdrop-blur-sm">
                            <p class="text-[7px] font-semibold text-white/45">Days</p>
