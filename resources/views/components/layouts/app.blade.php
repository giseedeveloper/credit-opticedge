...
<body class="h-full antialiased font-sans text-gray-900 selection:bg-[#4b0082] selection:text-white flex bg-[#E5E4E2]">
    ...
    <div class="flex-1 flex flex-col min-h-screen">
        <flux:header class="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border-b border-gray-200 dark:border-zinc-800 h-16 flex items-center justify-between px-4 lg:px-8 shadow-sm print:hidden">
            <div class="flex items-center gap-1">
                ...
                <span class="font-bold text-[#4b0082] dark:text-white tracking-tight lg:hidden ml-1">Opticedge Credit</span>
                ...
                <button
                    ...
                    class="hidden lg:flex flex-col items-center justify-center gap-[4.5px] w-9 h-9 rounded-xl bg-white border border-purple-200/80 text-[#4b0082] hover:bg-[#4b0082] hover:text-white hover:border-transparent hover:shadow-lg hover:shadow-purple-400/25 active:scale-95 transition-all duration-200"
                >
            ...
            <div class="flex-1 max-w-xl mx-auto hidden md:block relative" x-data>
                <flux:input 
                    ...
                    class="w-full bg-gray-50 text-gray-900 border-gray-300 focus:border-[#4b0082] transition-colors" 
                />
            </div>
            
            <div class="flex items-center gap-2">
                <button class="md:hidden text-gray-500 hover:text-[#4b0082] p-1">
