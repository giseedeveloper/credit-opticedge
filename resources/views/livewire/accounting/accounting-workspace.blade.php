<div>
    ...
    <div class="fixed inset-0 z-50 flex justify-end" x-data x-init="$nextTick(() => $el.focus())" tabindex="-1" @keydown.escape.window="$wire.closeJournalDetail()">
        ...
        <div class="relative w-full max-w-2xl h-full bg-white dark:bg-zinc-900 shadow-2xl flex flex-col"
            ...
            <div class="px-6 py-5 border-b border-gray-100 dark:border-zinc-800 bg-[#1a2035] flex items-start justify-between shrink-0">
                <div>
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <span class="px-2 py-0.5 rounded-full text-[10px] font-bold {{ $selectedEntry->source === 'manual' ? 'bg-indigo-500/30 text-indigo-200' : 'bg-teal-500/30 text-teal-200' }}">
            ...
            <div class="flex-1 overflow-y-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-zinc-800">
                        ...
                        @php
                        $typeBg = ['Asset'=>'bg-indigo-100 text-indigo-700','Liability'=>'bg-rose-100 text-rose-700','Equity'=>'bg-violet-100 text-violet-700','Revenue'=>'bg-teal-100 text-teal-700','Expense'=>'bg-amber-100 text-amber-700'];
                        @endphp
                        <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800/40 transition-colors">
                            ...
                            <td class="px-4 py-3 text-right font-mono font-bold {{ (float)$line->debit > 0 ? 'text-indigo-700 dark:text-indigo-300' : 'text-gray-300' }}">
                    ...
                    <tfoot>
                        <tr class="bg-[#1a2035] text-white">
                            ...
                            <td class="px-4 py-3 text-right font-mono font-black text-indigo-300">
            ...
            <div class="px-6 py-4 border-t border-gray-100 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-800/40 flex justify-between items-center shrink-0">
                ...
                <button wire:click="closeJournalDetail" class="px-5 py-2 text-sm font-semibold bg-[#1a2035] hover:bg-indigo-700 text-white rounded-xl transition-colors">
                    Close
                </button>
            </div>
        </div>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" wire:click.self="$set('showAccountModal',false)">
        <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-zinc-700 w-full max-w-md mx-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input wire:model="acCode" type="text" placeholder="e.g. 1000"
                               class="w-full px-3 py-2 text-sm border border-gray-200 dark:border-zinc-600 rounded-xl bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 font-mono" />
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-zinc-800/60 rounded-b-2xl flex justify-end gap-3">
                ...
                <button wire:click="saveAccount" class="px-5 py-2 text-sm font-semibold bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-colors shadow-sm">Save Account</button>
            </div>
        </div>
    </div>
    @endif
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" wire:click.self="$set('showJournalModal',false)">
        <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-zinc-700 w-full max-w-2xl mx-4 max-h-[90vh] flex flex-col">
            ...
            <div class="px-6 py-4 overflow-y-auto flex-1">
                    ...
                    <table class="w-full text-xs">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800/40">
                                <td class="px-2 py-1.5">
                                    <select wire:model="jeLines.{{ $i }}.account_id"
                                            class="w-full px-2 py-1.5 text-xs border border-gray-200 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-indigo-500">
                                ...
                                <td class="px-2 py-1.5">
                                    <input wire:model="jeLines.{{ $i }}.debit" type="number" step="0.01" min="0" placeholder="0.00"
                                           class="w-full px-2 py-1.5 text-xs text-right border border-gray-200 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-indigo-500 font-mono" />
                                </td>
                                <td class="px-2 py-1.5">
                        ...
                        <tfoot>
                            <tr class="bg-gray-50 dark:bg-zinc-800/40">
                                ...
                                <td class="px-3 py-2 text-xs font-black text-right font-mono text-indigo-700 dark:text-indigo-300">
                ...
                <button wire:click="addLine" class="text-xs text-indigo-600 font-semibold hover:text-indigo-800 flex items-center gap-1 transition-colors">
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-zinc-800/60 rounded-b-2xl flex justify-end gap-3 shrink-0">
                ...
                <button wire:click="saveJournalEntry" wire:loading.attr="disabled" class="px-5 py-2 text-sm font-semibold bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 text-white rounded-xl transition-colors shadow-sm flex items-center gap-2">
    ...
    <div class="flex items-start justify-between mb-6">
        ...
        <button wire:click="openJournalModal"
                class="flex items-center gap-2 px-4 py-2.5 text-sm font-bold bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-colors shadow-sm">
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-800 overflow-hidden">
        ...
        <div class="p-6">
            <div class="grid grid-cols-2 lg:grid-cols-5 gap-3 mb-6">
                ...
                $colorMap = [
                    'indigo' => ['bg'=>'bg-indigo-100 dark:bg-indigo-900/30','text'=>'text-indigo-600 dark:text-indigo-400','val'=>'text-indigo-700 dark:text-indigo-300'],
                    'rose'   => ['bg'=>'bg-rose-100 dark:bg-rose-900/30',    'text'=>'text-rose-600 dark:text-rose-400',    'val'=>'text-rose-700 dark:text-rose-300'],
                    'violet' => ['bg'=>'bg-violet-100 dark:bg-violet-900/30','text'=>'text-violet-600 dark:text-violet-400','val'=>'text-violet-700 dark:text-violet-300'],
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                <div class="lg:col-span-2">
                    ...
                    <div class="bg-gray-50 dark:bg-zinc-800/40 rounded-xl overflow-hidden">
                        ...
                        <div wire:click="viewJournalEntry('{{ $entry->id }}')" class="flex items-center gap-4 px-4 py-3 border-b border-gray-100 dark:border-zinc-800 last:border-0 hover:bg-white dark:hover:bg-zinc-800 transition-colors cursor-pointer group">
                            <div class="w-8 h-8 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 flex items-center justify-center shrink-0">
                            ...
                            <div class="text-right shrink-0">
                                <p class="text-xs font-bold font-mono text-indigo-700 dark:text-indigo-300">TZS {{ number_format((float)$entry->totalDebits(), 2) }}</p>
                            ...
                            <svg class="w-3.5 h-3.5 text-gray-300 group-hover:text-indigo-500 transition-colors shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.25 4.5l7.5 7.5-7.5 7.5"/></svg>
                        </div>
                        @empty
                ...
                <div>
                    ...
                    <div class="mt-3 p-3 rounded-xl bg-gray-50 dark:bg-zinc-800/40 flex items-center justify-between">
                        ...
                        <span class="text-sm font-black text-indigo-600">{{ number_format($overview['totalEntries']) }}</span>
                    </div>
                </div>
            </div>
        ...
        <div>
            <div class="px-5 py-3 border-b border-gray-100 dark:border-zinc-800 flex items-center gap-3 flex-wrap">
                <input wire:model.live.debounce.300="accountSearch" type="text" placeholder="Search code or name…"
                       class="px-3 py-2 text-sm border border-gray-200 dark:border-zinc-600 rounded-xl bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 w-64" />
                <select wire:model.live="accountTypeFilter"
                        class="px-3 py-2 text-sm border border-gray-200 dark:border-zinc-600 rounded-xl bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            ...
                            <td class="px-6 py-3 text-right">
                                <div class="flex items-center gap-3 justify-end">
                                    <button wire:click="openAccountModal('{{ $acc->id }}')"
                                            class="text-xs text-indigo-600 hover:text-indigo-800 font-semibold transition-colors">Edit</button>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-zinc-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800/40 transition-colors cursor-pointer group" wire:click="viewJournalEntry('{{ $entry->id }}')">
                            <td class="px-6 py-3 font-mono font-bold text-indigo-700 dark:text-indigo-300 text-xs">{{ $entry->reference }}</td>
                            ...
                            <td class="px-4 py-3 text-center">
                                <span class="px-2 py-0.5 rounded-full text-[10px] font-bold {{ $entry->source === 'manual' ? 'bg-indigo-100 text-indigo-700' : 'bg-teal-100 text-teal-700' }}">
                            ...
                            <td class="px-4 py-3 text-center">
                                <svg class="w-3.5 h-3.5 text-gray-300 group-hover:text-indigo-500 transition-colors mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.25 4.5l7.5 7.5-7.5 7.5"/></svg>
                            </td>
                        </tr>
                        @empty
            ...
            <div class="px-5 py-3 border-b border-gray-100 dark:border-zinc-800 flex items-center gap-3 flex-wrap justify-between">
                <div class="flex items-center gap-3 flex-wrap">
                    <select wire:model.live="ledgerAccountId"
                            class="px-3 py-2 text-sm border border-gray-200 dark:border-zinc-600 rounded-xl bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 min-w-[260px]">
                    ...
                    <span class="px-2.5 py-1 rounded-full text-xs font-bold
                        {{ ['Asset'=>'bg-indigo-100 text-indigo-700','Liability'=>'bg-rose-100 text-rose-700','Equity'=>'bg-violet-100 text-violet-700','Revenue'=>'bg-teal-100 text-teal-700','Expense'=>'bg-amber-100 text-amber-700'][$ledgerAccount->type] ?? 'bg-gray-100 text-gray-600' }}">
                        {{ $ledgerAccount->type }}
                    </span>
                    @endif
                </div>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-zinc-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800/40 transition-colors">
                            ...
                            <td class="px-4 py-2.5 font-mono text-xs font-bold text-indigo-700 dark:text-indigo-300">{{ $line->reference }}</td>
                            ...
                            <td class="px-4 py-2.5 text-right font-mono text-xs font-semibold {{ (float)$line->debit > 0 ? 'text-indigo-700 dark:text-indigo-300' : 'text-gray-300' }}">
                                {{ (float)$line->debit > 0 ? number_format((float)$line->debit, 2) : '—' }}
                            </td>
            ...
            <div class="max-w-xl mb-6">
                ...
                <div class="flex gap-3 mt-4">
                    <button wire:click="parseSelcomStatement" wire:loading.attr="disabled"
                            class="flex items-center gap-2 px-5 py-2.5 text-sm font-bold bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 text-white rounded-xl transition-colors shadow-sm">
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-zinc-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800/40 transition-colors {{ $hasImport && !$matched ? 'bg-rose-50/40 dark:bg-rose-900/5' : '' }}">
                            ...
                            <td class="px-4 py-3 text-right font-mono text-xs {{ $hasImport ? 'font-bold text-indigo-700 dark:text-indigo-300' : 'text-gray-300' }}">
