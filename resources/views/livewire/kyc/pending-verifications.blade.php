<div class="flex flex-col gap-6">
    ...
    @php
    $statDefs = [
        ['key' => 'total',       'label' => 'Total Pending', 'grad' => 'from-[#4b0082] to-[#7c3aed]', 'hero' => true, 'sub' => 'Awaiting review'],
        ['key' => 'not_started', 'label' => 'Not Started',   'icolor' => 'bg-zinc-100 dark:bg-zinc-800 text-zinc-500',     'sub' => 'No submission'],
        ['key' => 'pending',     'label' => 'In Review',     'icolor' => 'bg-amber-100 dark:bg-amber-900/30 text-amber-600','sub' => 'Submitted, waiting'],
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-gradient-to-br {{ $sd['grad'] }} rounded-2xl p-5 text-white relative overflow-hidden shadow-lg shadow-purple-900/20">
            ...
            <div class="flex items-center gap-2 mb-3">
                <div class="p-1.5 rounded-lg bg-white/20"><flux:icon name="identification" class="size-5" /></div>
        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50 dark:bg-zinc-800/80 border-b border-gray-100 dark:border-zinc-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">KYC Status</th>
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider hidden lg:table-cell">Registered</th>
            ...
            <tbody class="divide-y divide-gray-50 dark:divide-zinc-800">
                ...
                @php
                    ...
                    $kycLabel = $cv ? ucfirst($cv->status) : 'Not Started';
                ...
                <tr wire:key="kyc-{{ $customer->id }}" class="hover:bg-gray-50 dark:hover:bg-zinc-800/50 transition-colors">
                    <td class="px-4 py-3.5">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400">{{ $customer->email ?? ($customer->gender ? ucfirst($customer->gender) : '—') }}</p>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="px-4 py-3.5 text-xs text-gray-500 dark:text-gray-400 hidden lg:table-cell">
                    ...
                    <td class="px-4 py-3.5">
                        ...
                        @if($cv?->rejection_reason)
                        <p class="text-[10px] text-red-500 mt-0.5 truncate max-w-[130px]">{{ $cv->rejection_reason }}</p>
                        @endif
                    </td>
                    ...
                    <td class="px-4 py-3.5 text-right">
                        <div class="flex items-center justify-end gap-1">
                            ...
                            <button wire:click="openRejectModal('{{ $customer->id }}')"
                ...
                <tr>
                    <td colspan="7" class="px-4 py-16 text-center">
                        ...
                        <p class="text-gray-500 font-medium">All verifications are up to date!</p>
    ...
    {{-- ══ APPROVE MODAL ══ --}}
    <flux:modal wire:model="showApproveModal" name="approve-kyc">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 mb-4">This will mark the customer's identity as verified and allow loan processing.</p>
        <flux:field>
    ...
    {{-- ══ REJECT MODAL ══ --}}
    <flux:modal wire:model="showRejectModal" name="reject-kyc">
        <div class="flex items-center gap-3 mb-1">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 mb-4">The customer will be notified and can re-submit their documents.</p>
        <div class="space-y-4">
            <flux:field>
