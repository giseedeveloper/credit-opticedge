<div class="flex flex-col gap-6">
                ...
                <tr wire:key="brand-{{ $brand->id }}" class="hover:bg-zinc-50 dark:hover:bg-zinc-700/30 transition-colors">
                    <td class="px-4 py-3">
                        <div class="flex items-center gap-3">
                            <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-oe to-oe-hover flex items-center justify-center text-white font-black text-sm flex-shrink-0">
    ...
    <div x-data="{ open: @entangle('showBrandDetail') }"
        ...
        <div x-show="open"
            ...
            @if($detailBrand)
            <div class="flex items-start justify-between px-6 py-5 bg-gradient-to-r from-blue-700 to-oe-hover text-white">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <div class="bg-oe-soft dark:bg-oe/10 rounded-xl p-3 text-center">
                            <p class="text-[10px] text-oe uppercase tracking-wider">{{ ucfirst($specK) }}</p>
                            <p class="text-sm font-bold text-oe-hover dark:text-oe mt-0.5">{{ $specV }}</p>
                        </div>
                        @endforeach
                    </div>
                </div>
