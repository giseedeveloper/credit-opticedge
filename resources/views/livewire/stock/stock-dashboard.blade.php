<div class="flex flex-col gap-6">
    ...
    @php
        $cards = [
            ...
            ['label' => 'In Transit',   'key' => 'in_transit',   'color' => 'from-oe to-oe-hover',  'icon' => 'truck'],
    ...
    <div x-data="{ open: @entangle('showDetail') }"
        ...
        <div x-show="open"
            ...
            {{-- Slide header --}}
            <div class="flex items-start justify-between px-6 py-5 border-b border-zinc-100 dark:border-zinc-800 bg-gradient-to-r from-oe to-oe-hover text-white">
                <div>
            ...
            <div class="flex-1 px-6 py-5 space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <div class="bg-oe-soft dark:bg-oe/10 rounded-xl p-3 text-center">
                            <p class="text-[10px] text-oe uppercase tracking-wider">{{ ucfirst($specKey) }}</p>
                            <p class="text-sm font-bold text-oe-hover dark:text-oe mt-0.5">{{ $specVal }}</p>
                        </div>
                        @endforeach
                    </div>
                </div>
