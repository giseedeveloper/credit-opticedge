...
<head>
    ...
    <style>
        ...
        .header { text-align: center; border-bottom: 2px solid #4b0082; padding-bottom: 20px; margin-bottom: 20px; }
        .logo-text { color: #4b0082; font-size: 24px; font-weight: bold; }
        .section { margin-bottom: 20px; }
        .section h3 { background-color: #E5E4E2; padding: 10px; margin-bottom: 10px; color: #4b0082; }
        ...
        /* Mock Selfie Box */
        .photo-box { width: 100px; height: 100px; border: 1px dashed #4b0082; display: inline-block; vertical-align: top; text-align: center; line-height: 100px; font-size: 10px; color: #999; }
