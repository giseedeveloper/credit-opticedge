...
<head>
    ...
    <style>
        ...
        h1 { font-size: 18px; font-weight: 900; color: #4b0082; margin: 0 0 4px; }
        ...
        .total-row td { font-weight: 900; background: #ede9fe; color: #4b0082; }
        ...
        .code { font-family: monospace; font-weight: 700; color: #4b0082; }
    </style>
</head>
<body>
